...
export async function createGenerationJob(input, userId = demoUserId) {
...
export async function getGenerationJobById(id, userId = demoUserId) {
    return prisma.generationJob.findFirst({
        where: { id, userId },
        include: { template: true }
    });
}
export async function retryGenerationJob(jobId, actorAdminId) {
...
export async function cancelGenerationJob(jobId, actorAdminId) {
...
function resolveAssetTitle(templateTitle, mode) {
...
function buildMockOutput(jobId, publicAssetBaseUrl) {
    return {
        provider: 'mock',
